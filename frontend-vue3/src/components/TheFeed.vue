<template :key="reload">
    <section>
        ...
        <article v-else :key="index" v-for="(post, index) in posts">
            <div class="option" v-if="post.User.id_user == userId || moderator">
                ...
                <button v-if="post.User.id_user == userId" class="btn-delpost" @click="modalDelete(post.id_post)">Supprimer</button>
                <button v-if="moderator" class="btn-delpost" @click="moderatePost(post.id_post)">Modérer</button>
            </div>
            <div class="author">
                <img v-if="post.User.avatar" :src="post.User.avatar" class="author__avatar" alt="avatar de l'utilisateur">
            ...
            <router-link :to="`/post/view/${post.id_post}`">
                <div class="article__img">
                    <img :src="post.image_url" :alt="post.title"> 
                </div>
            </router-link>
            <Reaction :id_post="post.id_post" :moderator="moderator"></Reaction>           
        </article>
        <ModalDelPost v-if="modal" @delete="deletePost(deleteidpost)" @close="modal=false"></ModalDelPost>   
    </section>
</template>
...
<script>
    ...
    import ModalDelPost from './ModalDelPost.vue';
